...
export const svgGeometryGenerator = (globalScale: number, globalDepth: number, svg: SVGType, die: string, dieSize: number, d2Radius: number, isFace=false): Geometry | null => {
